      ...
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            <li><a href="https://www.youtube.com/@MoonlighterGames" target="_blank" rel="noopener noreferrer">YouTube</a></li>
        ...
        <div className="footer-section">
          ...
          <div className="social-links">
            ...
            <a href="https://www.youtube.com/@MoonlighterGames" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
